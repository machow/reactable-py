...
```{python}
import htmltools
from react_tables import bigblock, RT, options, Reactable
...
```{python}
Reactable(data=pl_penguins, searchable=True, min_rows=10)
```
...
Reactable(cat_penguins, wrap=False, resizable=True, bordered=True,)
